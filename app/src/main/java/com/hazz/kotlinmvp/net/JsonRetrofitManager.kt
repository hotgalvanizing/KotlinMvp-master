...
import com.hazz.kotlinmvp.api.ApiJsonService
...
object RetrofitJsonManager {


    val service: ApiJsonService by lazy(LazyThreadSafetyMode.SYNCHRONIZED) {
        getRetrofit().create(ApiJsonService::class.java)
    }
        ...
        return Interceptor { chain ->
            ...
            val modifiedUrl = originalRequest.url().newBuilder()
                    ...
                    .addQueryParameter("udid",
                            "d2807c895f0348a180148c9dfa6f2feeac0781b5")
